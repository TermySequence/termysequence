...
var strings = [
    ...
    "Use <b>qtermy</b>'s FUSE support to directly edit files on remote servers and in containers using local desktop applications. Or, use a local <b>sudo</b> or <b>su</b> <a doc='settings/connection.html'>connection</a> to directly edit root-owned files on the local machine.",
